...
When `file_capabilities` reports Aider support, the agent may instead choose `patchStrategy: "aider_block"` with a unique exact search and replacement block. Parseable source may support both strategies.
